...
const variants = {
    ...
    rightSide: {
        ...
        open: () => {
            ...
            if (typeof window !== "undefined" && window.outerWidth <= 1023) {
            ...
            {active && (
                ...
                >
                    ...
                    >
                        ...
                        <NavigationLink
                            current={
                                currentPath === "/credentials" ? true : false
                            }
                            href="/credentials"
                        >
                        ...
                        <div className="w-2/5 3xl:w-3/5 xl:w-full lg:mb-6 lg:px-4 lg:order-1 kh-font-description">
                            ...
                            <form className="flex flex-col">
                                <input
                                    ...
                                    placeholder={
                                        content.contactLabels.nameInput
                                    }
                                    type="text"
                                />
                                <input
                                    className="mb-4 border-dark-blue border-1 border-opacity-40 bg-transparent px-3 py-2 outline-none dark:border-champagne lg:mb-2"
                                    placeholder={
                                        content.contactLabels.emailInput
                                    }
                                    type="email"
                                />
                                <textarea
                                    className="mb-4 border-dark-blue border-1 border-opacity-40 bg-transparent px-3 py-2 outline-none dark:border-champagne lg:mb-2"
                                    placeholder={
                                        content.contactLabels.messageInput
                                    }
                                    rows="5"
                                />
                                <Button>
